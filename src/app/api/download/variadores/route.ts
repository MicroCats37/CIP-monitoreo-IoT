// app/api/variadores/download/route.ts
import { NextResponse } from "next/server";
import { getVariadoresDownloadData } from "@/influxDB/querys-download/VariadoresDownload";
...
export async function GET(request: Request) {
    try {
        ...
        const variador = searchParams.get("variador");
        ...
        const csv = await getVariadoresDownloadData(startTime, endTime, variador);
