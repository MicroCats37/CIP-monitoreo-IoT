...
import { getLastDefinedValueForField } from "@/utils/Devices/PlotFormat/functions";
...
export function SelectorInteractiveCharts({ name,chartData, chartConfig, YAxisFormatter, timeRange }: GeneralChartProps) {
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap justify-center">
                  ...
                  <span className="text-lg font-bold leading-none">{getLastDefinedValueForField(chartData,chart)?.value ?? 'N/A'}{' '}{chartConfig[chart].unit}</span>
                </div>
              </button>
            )
          })}
          ...
          {chartConfig[activeChart].label === "Velocidad y Dirección" ? (
            ...
            >
              ...
              <YAxis
                ...
                orientation="left"
                stroke={`var(--color-${activeChart})`}
                unit={chartConfig[activeChart] && chartConfig[activeChart].unit ? chartConfig[activeChart].unit.toString() : undefined}
              />
              <ChartTooltip
                cursor={true}
                content={
