...
import { formatDateTimeByRange } from "@/utils/Devices/PlotFormat/ToolTip/formatDateTimeByRange"
...
export function StackedChart({ name, chartData, chartConfig, plotType, chartIndex, timeRange }: ChartProps) {
        ...
        >
          ...
          >
            ...
            <XAxis
              ...
              tickFormatter={(value) => (formatDateTimeByRange(new Date(value).toISOString(), timeRange))}
            />
            <YAxis
              yAxisId="left"
              domain={["auto", "auto"]}
