...
export default function CO2Card({ data }: { data: CO2Type[] }) {
  return (
    <div className="flex gap-6 w-full flex-col lg:flex-row">
      {data.map((location, index) => {
        const status = getCO2Status(location.data.co2)
            ...
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <CardTitle className="text-2xl font-bold">{location.data.lugar}</CardTitle>
