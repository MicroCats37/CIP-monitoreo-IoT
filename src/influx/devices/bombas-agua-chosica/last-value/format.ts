import { bombasDeAguaChosicaSchema, BombasDeAguaChosicaType } from "@/validators/devices/schemas";
...
export const formatterBombasChosica = (
  rawRecords: Array<Record<string, unknown>>
): BombasDeAguaChosicaType => {
  ...
  const result: BombasDeAguaChosicaType = {
    device: {
  ...
  return bombasDeAguaChosicaSchema.parse(result);
};
